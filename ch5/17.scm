...
;; wrap (lambda() ... ) around each call to apply-procedure/k,
;; this change does NOT need any other modifcation on contract
    ...
    (cases continuation cont
           ...
           (rand-cont (val1 saved-cont)
                      (let ((proc (expval->proc val1)))
                        (lambda () (apply-procedure/k proc val saved-cont))))
           )))
