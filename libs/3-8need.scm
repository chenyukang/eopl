(let ((time-stamp "Time-stamp: <2001-08-03 13:00:35 dfried>"))
  (eopl:printf "3-8need.scm - interp with call by need ~a~%"
...
(define run-all
  (lambda ()
    (run-experiment run use-execution-outcome
      '(lang3-1 lang3-5 lang3-6 lang3-7 lang3-8need) all-tests)))
